...
const TaskModal = ({ isOpen, onClose, taskToEdit, onSave, onLogout }) => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        console.error(error);
        setError(error.message || "An error message occurred");
      } finally {
        setLoading(false);
      }
    },
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-sm bg-black/20 z-50 flex items-center justify-center p-4">
      <div className="bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative animate-fadeIn p-8">
