        ...
        <div className="fixed inset-0 z-40">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 mt-16 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600 flex items-center justify-center text-white font-bold shadow-md">
                {initial}
              </div>
              <div>
